...
const Signup = () => {
    ...
    const onSubmit = async (data: InputType) => {
        setIsLoading(true) // "ture" のタイプミスを修正
        ...
        try {
            ...
            const res = await temporarrySignup({
                ...
                rePassword: data.password, // data.Password のタイプミスを修正
            })
        ...
        <div className="max-w-[400px] m-auto">
            {isSignUp ? (
                <>
                    ...
                    <div className="">
                        アカウント登録に必要なメールを送信しました。
                        <br />
                        メール内のリンクをクリックして本登録画面に進んでいただき、本登録を完了してください。
                        <br />
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            <div className="text-sm text-gray-500">
                                サインアップすることで、利用規約、プライバシーポリシーに同意するものとします。
                            </div>
